...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--merge_weekday_output_dirs", type=lambda s: str(s).lower() in ("true", "1", "yes", "y"), default=False, help="Whether to allow weekly_posts.py to merge contiguous duplicate weekday output directories (default: False)")  # Register weekday merge argument for shared Makefile arguments.
